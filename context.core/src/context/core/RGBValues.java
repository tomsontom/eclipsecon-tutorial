...
public class RGBValues {
	public static List<RGB> RGBS = new ArrayList<RGB>();

	static void put(String name, String hexValue) {
		int redValue = Integer.decode("0x" + hexValue.substring(1, 3))
				.intValue();
		int greenValue = Integer.decode("0x" + hexValue.substring(3, 5))
				.intValue();
		int blueValue = Integer.decode("0x" + hexValue.substring(5))
				.intValue();
		RGBS.add(new RGB(redValue, greenValue, blueValue));
	}
