 ...
 *
 */
	public class BetterImpl implements EModelService{
	 ...
	 */
	public BetterImpl(IEclipseContext appContext) {
		if (appContext == null)
			return;
	...
	public MUIElement find(String id, MUIElement searchRoot) {
		System.err.println(" Keep your service for yourself as my better service finds it for me. E4FTW.");
